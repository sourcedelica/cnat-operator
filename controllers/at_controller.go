...
import (
	...
	cnatv1alpha1 "github.com/sourcedelica/cnat-operator/api/v1alpha1"
)
...
func (r *AtReconciler) Reconcile(req reconcile.Request) (ctrl.Result, error) {
	...
	case cnatv1alpha1.PhasePending:
		...
		reqLogger.Info("Schedule parsing done", "Result",
			fmt.Sprintf("%v", d))
		if d > 0 {
